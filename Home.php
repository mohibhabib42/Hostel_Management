...
if(isset($_POST['search']) && isset($_POST['sid'])){
    ...
    $email = $_POST['sid'];
    $sql4 = "SELECT * FROM `student` WHERE `email`= '$email' ;";
    ...
    <body class="d-flex">
        ...
        <nav class="nav h-100 w-25 text-white small d-flex flex-column align-content-center" style="background-color: #220646;">
            ...
            <div class="navbar-nav mt-5">
                <a href="./Home.php" class="nav-item nav-link active text-decoration-none mb-4 w-100 pb-1 pt-1">Dashboard</a>
        ...
        <div class="h-100 w-75" style="background-color: rgba(237, 242, 247, 1);color: rgba(160, 174, 192, 1); box-sizing: border-box;">
            ...
            <nav class="navbar bg-light">
                ...
                <h5 class="mx-5">Overview</h5>
                <span style="color: #CBD5E0;" class="m-2">
                <form method="POST">
                    <input name="sid" style="outline: none; border:1px solid #CBD5E0;" class="rounded  p-2 bg-light" placeholder="Enter ID"/>
            ...
            <div class="table mx-4 mt-3 py-2 rounded" style=" height: 83%; width: 95%; background-color: white;overflow-y: auto;">
                ...
                <table class="w-100">
                    <thead class="thead border-1 sticky-top" style="color:#4A5568;background-color: rgba(237, 242, 247, 1);">
                        <tr>
                            <th class="px-5 fw-normal py-1">First Name</th>
                            <th class="px-5 fw-normal py-1">Email</th>
                            <th class="px-5 fw-normal py-1">Room ID</th>
                            <th class="px-5 fw-normal py-1">Dues</th>
                            <th class="px-5 fw-normal py-1">Action</th>
                        </tr>
                    </thead>
                    <tbody>
                    <?php 
                        ...
                        <tr>  
                            ...
                            <td> 
                                    ...
                                    style="outline :none;background-color: #38b2ac;color:#ffff"
                                    href="./Delete.php?name=<?php echo $row['room'] ; ?>&id=<?php echo $row['email'] ; ?>">
                                    Delete
                                    </a>
                            </td>
                        </tr>
